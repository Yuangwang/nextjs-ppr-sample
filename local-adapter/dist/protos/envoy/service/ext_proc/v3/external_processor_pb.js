 ...
 */
export const ProtocolConfigurationSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 0);
/**
 ...
 */
export const ProcessingRequestSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 1);
/**
 ...
 */
export const ProcessingResponseSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 2);
/**
 * Describes the message envoy.service.ext_proc.v3.HttpHeaders.
 * Use `create(HttpHeadersSchema)` to create a new message.
 */
export const HttpHeadersSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 3);
/**
 * Describes the message envoy.service.ext_proc.v3.HttpBody.
 * Use `create(HttpBodySchema)` to create a new message.
 */
export const HttpBodySchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 4);
/**
 * Describes the message envoy.service.ext_proc.v3.HttpTrailers.
 * Use `create(HttpTrailersSchema)` to create a new message.
 */
export const HttpTrailersSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 5);
/**
 * Describes the message envoy.service.ext_proc.v3.HeadersResponse.
 * Use `create(HeadersResponseSchema)` to create a new message.
 */
export const HeadersResponseSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 6);
/**
 * Describes the message envoy.service.ext_proc.v3.BodyResponse.
 * Use `create(BodyResponseSchema)` to create a new message.
 */
export const BodyResponseSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 7);
/**
 ...
 */
export const TrailersResponseSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 8);
/**
 * Describes the message envoy.service.ext_proc.v3.CommonResponse.
 * Use `create(CommonResponseSchema)` to create a new message.
 */
export const CommonResponseSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 9);
/**
 * The status of the response.
 *
 * @generated from enum envoy.service.ext_proc.v3.CommonResponse.ResponseStatus
 */
export var CommonResponse_ResponseStatus;
(function (CommonResponse_ResponseStatus) {
    /**
     ...
     */
    CommonResponse_ResponseStatus[CommonResponse_ResponseStatus["CONTINUE"] = 0] = "CONTINUE";
    /**
     ...
     */
    CommonResponse_ResponseStatus[CommonResponse_ResponseStatus["CONTINUE_AND_REPLACE"] = 1] = "CONTINUE_AND_REPLACE";
})(CommonResponse_ResponseStatus || (CommonResponse_ResponseStatus = {}));
/**
 * Describes the enum envoy.service.ext_proc.v3.CommonResponse.ResponseStatus.
 */
export const CommonResponse_ResponseStatusSchema = /*@__PURE__*/ enumDesc(file_envoy_service_ext_proc_v3_external_processor, 9, 0);
/**
 ...
 */
export const ImmediateResponseSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 10);
/**
 * Describes the message envoy.service.ext_proc.v3.GrpcStatus.
 * Use `create(GrpcStatusSchema)` to create a new message.
 */
export const GrpcStatusSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 11);
/**
 * Describes the message envoy.service.ext_proc.v3.HeaderMutation.
 * Use `create(HeaderMutationSchema)` to create a new message.
 */
export const HeaderMutationSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 12);
/**
 ...
 */
export const StreamedBodyResponseSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 13);
/**
 * Describes the message envoy.service.ext_proc.v3.BodyMutation.
 * Use `create(BodyMutationSchema)` to create a new message.
 */
export const BodyMutationSchema = /*@__PURE__*/ messageDesc(file_envoy_service_ext_proc_v3_external_processor, 14);
/**
 ...
 */
export const ExternalProcessor = /*@__PURE__*/ serviceDesc(file_envoy_service_ext_proc_v3_external_processor, 0);
